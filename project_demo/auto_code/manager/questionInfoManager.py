from ..models.questionInfoModel import QuestionInfo as _QuestionInfo
...
class QuestionInfoManager(_QuestionInfo):
    @classmethod
    def add(cls, **kwargs):
        QuestionID = kwargs.get('QuestionID')
        SubjectID = kwargs.get('SubjectID')
        QuestionText = kwargs.get('QuestionText')
        ...
        if QuestionText:
            filter_list.append(cls.QuestionText == QuestionText)
        if AnswerText:
    ...
    def update(cls, **kwargs):
        ...
        if QuestionText:
            args['QuestionText'] = QuestionText
        if AnswerText:
