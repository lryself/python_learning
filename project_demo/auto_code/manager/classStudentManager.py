from ..models.classStudentModel import ClassStudent as _ClassStudent
...
class ClassStudentManager(_ClassStudent):
    ...
    def add(cls, **kwargs):
        ...
        if StudentType:
            filter_list.append(cls.StudentType == StudentType)
        if IsDelete:
